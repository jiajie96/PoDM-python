...
FFHQ_images  = np.load('FFHQ_train_64.npy')
FFHQ_images  = FFHQ_images[:10000]
# dataset_path = 'FFHQ'
# dataset_files_list = os.listdir(dataset_path)
# print(len(dataset_files_list))

# row_images=[]
# for dataset_file_name in dataset_files_list[1000:]:
...
np.save('FFHQ_train_64_10k.npy', FFHQ_images)
